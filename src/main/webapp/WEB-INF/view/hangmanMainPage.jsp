...
<div>
<div style="display:inline-block"><p>Current word: </p></div> 
<p style="display:inline-block" id="puzzled-word">${gameSessionObj.puzzledWord}</p> 
</div>

<div>
<div style="display:inline-block"><p>Tries Left: </p></div> 
<p style="display:inline-block" id="tries-left">${gameSessionObj.triesLeft}</p> 
</div>

<div>
<div style="display:inline-block"><p>Number of letters to guess : </p></div> 
...
<form action="${gameSessionObj.gameId}"  method="post">
  ...
  <input id="submit-letter-btn" class="submit-btn" type="submit" value="Submit letter!">
</form>
	
<!-- Invisible to user, for test purpose only -->
<form style="visibility: hidden" method="post" action="games" class="inline">
